...
if __name__ == "__main__":
    ...
    for data in tqdm(dataloader):
        ...
        # m0_vailid = pad(m0_vailid, padding_m, value=False)

        # print(m0_vailid.shape)
        # print(m0_vailid)

        list_batch.append(desc_all)


    path = f'/home/koki/Sparse_Matcher/data/Megadepth/Superpoint_features/scene_no_15_22_features/sp_feature_test2.pth'
    torch.save(list_batch, path)
    ...
    #     desc0 = pad(desc0, padding_d0).cpu()[None]
    #     desc1 = pad(desc1, padding_d1).cpu()[None]
    #     desc_match0 = pad(desc_match0, padding_m).cpu()[None]
    #     desc_match1 = pad(desc_match1, padding_m)[None]

    #     desc_all = [desc0,desc1,desc_match0,desc_match1]
    #     desc_all = torch.cat(desc_all, dim=0).numpy()
